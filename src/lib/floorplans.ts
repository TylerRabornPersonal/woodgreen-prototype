...
export const TRACED_PLANS: Record<string, TracedPlan> = {
  ...
  "1993-second": {
    vb: "55 90 935 480",
    fill:
      "256,104 785,104 785,270.5 970,270.5 970,430.5 785,430.5 785,550 256,550 256,430.5 70,430.5 70,270.5 256,270.5",
    walls: [
      "256,104 785,104 785,270.5 970,270.5 970,430.5 785,430.5 785,550 256,550 256,430.5 70,430.5 70,270.5 256,270.5 256,104",
    ],
    rooms: {
  ...
  "2001-second": {
    ...
    rooms: {
      // standard 5px gaps between adjacent rooms
      A: { x: 244, y: 75, w: 148, h: 170 },
      B: { x: 594, y: 75, w: 156, h: 170 },
      C: { x: 32, y: 252, w: 133, h: 143 },
      D: { x: 170, y: 252, w: 114, h: 143 },
      F: { x: 600, y: 300, w: 114, h: 180 },
      G: { x: 719, y: 300, w: 130, h: 134 },
      E: { x: 854, y: 300, w: 115, h: 134 },
      I: { x: 332, y: 345, w: 138, h: 135 },
      H: { x: 475, y: 345, w: 120, h: 135 }, // stretched right to 5px from F
    },
    fixed: [
  ...
  "2001-basement": {
    vb: "245 108 492 495",
    fill:
      "444,120 606.7,120 606.7,164 720,164 720,580.7 400.7,580.7 400.7,319.4 314.7,319.4 314.7,359 260,359 260,241 314.7,241 314.7,280.7 444,280.7",
    walls: [
      "444,120 606.7,120 606.7,164 720,164 720,580.7 400.7,580.7 400.7,319.4 314.7,319.4 314.7,359 260,359 260,241 314.7,241 314.7,280.7 444,280.7 444,120",
    ],
    rooms: {
      // rounded rects with standard 5px gaps
      SVR: { x: 444, y: 120, w: 160.2, h: 160.7 },
      LCK: { x: 609.2, y: 164, w: 110.8, h: 116.7 },
      FL: { x: 400.7, y: 319.4, w: 157.5, h: 261.3 },
      FR: { x: 563.2, y: 319.4, w: 156.8, h: 261 },
    },
    fixed: [],
  },
};
