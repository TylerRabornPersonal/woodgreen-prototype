...
export const TRACED_PLANS: Record<string, TracedPlan> = {
  ...
  "2001-main": {
    ...
    rooms: {
      ...
      B2: {
        x: 580.2, y: 120.0, w: 63.45, h: 89.6,
        points: "580.2,143.7 608.1,143.7 608.1,120 643.65,120 643.65,209.6 580.2,209.6",
      },
      B3: { x: 643.65, y: 120.0, w: 73.45, h: 65.2 },
      ...
      P7: {
        x: 587.7, y: 322.8, w: 55.15, h: 81.0,
        points: "587.7,322.8 642.85,322.8 642.85,403.8 608.1,403.8 608.1,386.2 587.7,386.2",
      },
      P6: { x: 642.85, y: 322.8, w: 60.65, h: 81.0 },
